...
class ChatCreateActionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create(
            'chat_caches', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'chat_contacts', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'chat_activities', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'chat_conversation_types', function (Blueprint $table) {
                $table->increments('id');
                $table->string('name');
        ...
        Schema::create(
            'chat_hears', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'chat_questions', function (Blueprint $table) {
                $table->increments('id');
                $table->integer('chat_conversation_type_id');
                $table->string('text');
                $table->timestamps();
        ...
        Schema::create(
            'chat_users', function (Blueprint $table) {
                $table->increments('id');
        ...
        Schema::create(
            'chat_actions', function (Blueprint $table) {
                $table->increments('id');
