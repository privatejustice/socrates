...
<h2><a href="{crmURL p='socrates/chat/conversationType/view' q="id=`$conversationType.id`"}">{$conversationType.name}</a></h2>
...
<br/>
<a class="btn btn-primary" href="{crmURL p='socrates/chat/conversationType/add'}" role="button">{ts}Add a conversation type{/ts}</a>
