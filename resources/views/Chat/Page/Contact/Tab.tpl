...
<div class="action-link">
  <a accesskey="N" href='{crmURL p="socrates/sms/conversation/schedule" q="cid=`$contactId`"}' class="button medium-popup"><span><i class="crm-i fa-comment"></i> Schedule Conversation</span></a>
</div>
...
<script type="text/javascript">
    (function($) {
        ...
        $('table.crm-chat-selector').data({
            "ajax": {
                "url": {/literal}'{crmURL p="socrates/ajax/chat/list" h=0 q="snippet=4&cid=`$contactId`"}'{literal},
                "data": function (d) {
                }
            },
            "language": {
