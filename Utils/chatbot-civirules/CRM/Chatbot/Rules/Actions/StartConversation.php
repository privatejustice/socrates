...
class CRM_Chatbot_Rules_Actions_StartConversation extends CRM_CivirulesActions_Generic_Api {
  ...
  public function getExtraDataInputUrl($ruleActionId) {
    return CRM_Utils_System::url('socrates/civirule/form/action/conversation/start', 'rule_action_id='.$ruleActionId);
  }
   ...
   * @param CRM_Civirules_Bao\Rule $rule
   * @return bool
   */
  public function doesWorkWithTrigger(CRM_Civirules_Trigger $trigger, CRM_Civirules_Bao\Rule $rule) {
