 ...
 * extension.
 */
class Socrates\Chat\ExtensionUtil {
 ...
 */
function _chatbot_civix_socrates_config(&$config = NULL) {
 ...
 */
function _chatbot_civix_socrates_xmlMenu(&$files) {
 ...
 */
function _chatbot_civix_socrates_install() {
  _chatbot_civix_socrates_config();
 ...
 */
function _chatbot_civix_socrates_postInstall() {
  _chatbot_civix_socrates_config();
  if ($upgrader = _chatbot_civix_upgrader()) {
 ...
 */
function _chatbot_civix_socrates_uninstall() {
  _chatbot_civix_socrates_config();
  if ($upgrader = _chatbot_civix_upgrader()) {
 ...
 */
function _chatbot_civix_socrates_enable() {
  _chatbot_civix_socrates_config();
  if ($upgrader = _chatbot_civix_upgrader()) {
 ...
 * @return mixed
 */
function _chatbot_civix_socrates_disable() {
  _chatbot_civix_socrates_config();
  if ($upgrader = _chatbot_civix_upgrader()) {
 ...
 */
function _chatbot_civix_socrates_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  if ($upgrader = _chatbot_civix_upgrader()) {
...
function _chatbot_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/Chat/Upgrader.php')) {
    ...
    return Socrates\Chat\Upgrader_Base::instance();
  }
}
 ...
 */
function _chatbot_civix_socrates_managed(&$entities) {
 ...
 */
function _chatbot_civix_socrates_caseTypes(&$caseTypes) {
 ...
 */
function _chatbot_civix_socrates_angularModules(&$angularModules) {
 ...
 */
function _chatbot_civix_socrates_alterSettingsFolders(&$metaDataFolders = NULL) {
