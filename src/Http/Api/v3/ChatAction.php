 ...
 */
function _socrates_api3_chat_action_create_spec(&$spec) {
 ...
 */
function socrates_api3_chat_action_create($params) {
 ...
 * @throws API_Exception
 */
function socrates_api3_chat_action_delete($params) {
 ...
 * @throws API_Exception
 */
function socrates_api3_chat_action_get($params) {
