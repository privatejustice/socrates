 ...
 */
function _socrates_api3_chat_cache_create_spec(&$spec) {
 ...
 */
function socrates_api3_chat_cache_create($params) {
 ...
 * @throws API_Exception
 */
function socrates_api3_chat_cache_delete($params) {
 ...
 * @throws API_Exception
 */
function socrates_api3_chat_cache_get($params) {
