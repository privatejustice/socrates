...
class Add extends \Socrates\Chat\Form\Good {
  ...
  public function validate() {
    ...
    if($submitted['ChatAction:match'] == 'Socrates\Check_Contains' && empty($submitted['ChatAction:match_contains'])){
      $this->_errors['ChatAction:match_contains'] = 'This field cannot be blank';
    }
    if($submitted['ChatAction:match'] == 'Socrates\Check_Equals' && empty($submitted['ChatAction:match_equals'])){
